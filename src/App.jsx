...
const ADMIN_ONLY_PAGES = new Set(['AdminContentManagement', 'AdminUsers', 'AdminApproval', 'AdminApplications', 'AdminMetrics', 'AdminMonitoring', 'AdminPayments', 'AdminRewards', 'AdminRewardClaims', 'Leaderboard']);
