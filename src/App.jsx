...
const ADMIN_ONLY_PAGES = new Set(['AdminContentManagement', 'AdminUsers', 'AdminScriptApproval', 'AdminApproval', 'AdminApplications', 'AdminMetrics', 'AdminMonitoring', 'AdminPayments', 'AdminRewards', 'AdminRewardClaims', 'Leaderboard']);
...
const PasswordRecoveryRedirect = () => {
  ...
  if (loading || !isPasswordRecovery || location.pathname === '/ResetPassword') {
    return null
  }
