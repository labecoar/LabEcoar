...
export default function Forum() {
  ...
  const { data: topics, isLoading } = useQuery({
    ...
    queryFn: () => base44.entities.ForumTopic.list('-last_activity'),
    initialData: [],
  });
  ...
  const createTopicMutation = useMutation({
    mutationFn: async (topicData) => {
      ...
      return base44.entities.ForumTopic.create({
        ...topicData,
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-2">Converse, compartilhe e aprenda com outros Ecoantes</p>
          </div>
