...
export default function MyTasks() {
  ...
  const renderSubmissionCard = (submission) => (
    <Card 
      key={submission.id}
      className="shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer border-emerald-100 bg-white/80 backdrop-blur-sm"
      ...
      <CardContent className="space-y-3">
        ...
        <div className="flex items-center gap-4 pt-3 border-t border-emerald-100">
          <div>
            ...
            <p className="font-bold text-yellow-700">{submission.reward_points}</p>
          </div>
          <div>
            <p className="text-xs text-gray-500">Ganho</p>
            <p className="font-bold text-green-700">R$ {submission.reward_money?.toFixed(2)}</p>
          </div>
    ...
    <div className="p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Acompanhe o status das suas submissões</p>
        </div>
