  ...
  return (
    <div className="min-h-screen flex">
        <div className="relative flex w-full min-h-screen overflow-hidden" style={{ backgroundColor: C.black }}>
          ...
          <div className="relative flex flex-col items-center justify-center h-full min-h-screen shrink-0 overflow-y-auto w-full md:w-1/2" style={{ maxWidth: 680, backgroundColor: C.cream }}>
            <div className="flex flex-col gap-7 w-full max-w-[400px] px-6 py-10">
              <div className="flex flex-col gap-2">
                {mode === 'signup' && (
                  <button
                    type="button"
                    onClick={() => setMode('login')}
                    className="text-sm text-slate-500 hover:text-slate-700 inline-flex items-center gap-1 w-fit mb-2"
                  >
                ...
                <h1 style={{ ...heading, fontWeight: 800, fontSize: 34, color: C.black, lineHeight: 1.1, letterSpacing: "-0.02em" }}>
                  {mode === 'login' ? 'Que bom ter você aqui!' : 'Crie sua conta'}
                </h1>
                <p style={{ ...body, fontSize: 14, color: "#6b6b69" }}>
                  {mode === 'login' ? 'Entre na sua conta para continuar.' : 'Preencha os dados abaixo para se cadastrar.'}
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                {mode === 'signup' && (
                  <div className="flex flex-col gap-1.5">
                    <label style={{ ...body, fontSize: 11, fontWeight: 700, color: C.black, letterSpacing: "0.05em" }}>NOME</label>
                    <div className="flex items-center px-4 h-[50px] rounded-xl bg-white" style={{ border: `1.5px solid ${error ? "#FF2255" : "#d9d9d6"}`, boxShadow: "0 1px 4px rgba(0,0,0,0.04)" }}>
                      ...
                      <input
                        ...
                        style={{ ...body, fontSize: 14, color: C.black }}
                        disabled={loading}
                        required
                      />
                    </div>
                ...
                <div className="flex flex-col gap-1.5">
                  <label style={{ ...body, fontSize: 11, fontWeight: 700, color: C.black, letterSpacing: "0.05em" }}>E-MAIL</label>
                  <div className="flex items-center px-4 h-[50px] rounded-xl bg-white" style={{ border: `1.5px solid ${error ? "#FF2255" : "#d9d9d6"}`, boxShadow: "0 1px 4px rgba(0,0,0,0.04)" }}>
                ...
                <div className="flex flex-col gap-1.5">
                  <div className="flex items-center justify-between">
                    <label style={{ ...body, fontSize: 11, fontWeight: 700, color: C.black, letterSpacing: "0.05em" }}>SENHA</label>
                    {mode === 'login' && (
                      <button
                        type="button"
                  ...
                  <div className="flex items-center px-4 h-[50px] rounded-xl bg-white" style={{ border: `1.5px solid ${error ? "#FF2255" : "#d9d9d6"}`, boxShadow: "0 1px 4px rgba(0,0,0,0.04)" }}>
                    ...
                    <input
                      ...
                      required
                    />
                    <button type="button" onClick={() => setShowPassword(!showPassword)} style={{ color: "#353535", opacity: 0.45 }} className="hover:opacity-80 transition-opacity">
                      {showPassword
                ...
                {mode === 'signup' && (
                  <div className="flex flex-col gap-1.5">
                    <label style={{ ...body, fontSize: 11, fontWeight: 700, color: C.black, letterSpacing: "0.05em" }}>CONFIRME A SENHA</label>
                    <div className="flex items-center px-4 h-[50px] rounded-xl bg-white" style={{ border: `1.5px solid ${error ? "#FF2255" : "#d9d9d6"}`, boxShadow: "0 1px 4px rgba(0,0,0,0.04)" }}>
                      <Lock className="w-4 h-4 text-slate-400 mr-2" />
                      <input
                        ...
                        required
                      />
                      <button type="button" onClick={() => setShowConfirmPassword(!showConfirmPassword)} style={{ color: "#353535", opacity: 0.45 }} className="hover:opacity-80 transition-opacity">
                        {showConfirmPassword
                          ? <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" /><circle cx="12" cy="12" r="3" /></svg>
                          : <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24" /><line x1="1" y1="1" x2="23" y2="23" /></svg>
                        }
              ...
              <div className="flex items-center justify-center gap-1.5 mt-2">
                <span style={{ ...body, fontSize: 13, color: "#737370" }}>
