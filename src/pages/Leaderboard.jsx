...
export default function Leaderboard() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: C.black, ...body }}>
      ...
      <div className="px-4 md:px-8 pt-7 pb-10 max-w-4xl mx-auto space-y-10">
              ...
              {rest.map((entry, index) => {
                ...
                return (
                  <div key={entry.user_id}
                    ...
                    style={{
                      borderBottom: index < rest.length - 1 ? `1px solid rgba(255,255,222,0.05)` : 'none',
                    ...
                    <div className="w-8 h-8 rounded-full flex items-center justify-center shrink-0 text-xs font-black"
                      style={{ backgroundColor: 'rgba(255,255,222,0.06)', color: `${C.cream}50` }}>
                      {rank}
                    </div>
